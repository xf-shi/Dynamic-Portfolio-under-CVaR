...
| Model | Active tail wealth CVaR | Inactive → active mean wealth | Inactive → active exposure | Validation sample |
|---|---:|---:|---:|---:|
| Complete market | 0.9400 | 1.0323 → 1.0242 | 0.4000 → 0.3001 | 5,000 paths |
| Incomplete market | 0.9400 | 1.0317 → 1.0205 | 0.4000 → 0.2601 | 20,000 holdout paths |
| Linear control | 0.9409 | 1.0251 → 1.0197 | 0.3105 → 0.2421 | 40 validation seeds |
| Square-root impact | 0.9409 | 1.0260 → 1.0180 | 0.3500 → 0.2422 | 50,000 OOS paths |
